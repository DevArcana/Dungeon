...
namespace WorldGeneration
{
    ...
    public class VoxelGrid : MonoBehaviour
    {
        ...
        private void AddQuad (Vector3 a, Vector3 b, Vector3 c, Vector3 d) {
            ...
            vertices.Add(new Vector3(b.x, 0.0f, b.y));
            vertices.Add(new Vector3(c.x, 0.0f, c.y));
            vertices.Add(new Vector3(d.x, 0.0f, d.y));
            triangles.Add(vertexIndex);
            triangles.Add(vertexIndex + 1);
            triangles.Add(vertexIndex + 2);
            triangles.Add(vertexIndex);
        ...
        private void AddPentagon (Vector3 a, Vector3 b, Vector3 c, Vector3 d, Vector3 e) {
            ...
            vertices.Add(new Vector3(c.x, 0.0f, c.y));
            vertices.Add(new Vector3(d.x, 0.0f, d.y));
            vertices.Add(new Vector3(e.x, 0.0f, e.y));
            triangles.Add(vertexIndex);
            triangles.Add(vertexIndex + 1);
            triangles.Add(vertexIndex + 2);
            triangles.Add(vertexIndex);
        ...
        {
            var o = Instantiate(voxelPrefab, transform);
            o.transform.localPosition = new Vector3((x + 0.5f) * voxelSize, 0.001f, (y + 0.5f) * voxelSize);
        ...
        public void Apply (VoxelStencil stencil) {
            ...
            for (int y = yStart; y <= yEnd; y++) {
                ...
                for (int x = xStart; x <= xEnd; x++, i++) {
                    voxels[i].state = stencil.Apply(x, y);
                }
            }
            Refresh();
        }
